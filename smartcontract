...
contract BABYDRAGON is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x0E2B45f5F6DdcA231C2CEE63DFFf63770057B8eB);
    ...
    constructor(address _owner) ERC20("BabyDragon", "BDRAG") {
        ...
        */
        _createTotalSupply(_owner, 1000000000 * (10**18));
    ...
    function SetFee(uint256 _marketingFee) public onlyOwner {
        require(_marketingFee <= 25, "decrease fee");
